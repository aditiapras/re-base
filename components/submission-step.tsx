...
const steps = [
    { title: "Registrasi", icon: BookUser },
    { title: "Pembayaran", icon: CreditCard },
    { title: "Verifikasi", icon: LockKeyhole },
    { title: "Kelulusan", icon: ListTodo },
];
...
export default function SubmissionStep() {
    ...
    return (
        <Stepper
            ...
            className="space-y-8 border-b"
        >
            <StepperNav className="gap-3 mb-4">
